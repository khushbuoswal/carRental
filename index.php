  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <div style="position: absolute; top: 64%; left: 67.6%; transform: translate(-50%, -50%); text-align: center;">
          <h1 style="color: rgb(3, 87, 3); font-size: 37px;">WE'RE READY</h1>
          <h1 style="color: rgb(3, 87, 3); font-size: 37px">WHEN YOU'RE</h1>
          <h1 style="color: rgb(3, 87, 3); font-size: 37px">READY</h1>
          <a href="all.php" class="btn btn-outline-success">EXPLORE</a>
        </div>
      </div>
    </div>
  </div>
